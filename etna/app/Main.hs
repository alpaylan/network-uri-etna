...
allProperties = ["PathSegmentsRoundTrip"]
...
witnessesFor "PathSegmentsRoundTrip" =
  [ ("witness_path_segments_round_trip_case_three",  W.witness_path_segments_round_trip_case_three)
  , ("witness_path_segments_round_trip_case_single", W.witness_path_segments_round_trip_case_single)
  , ("witness_path_segments_round_trip_case_two",    W.witness_path_segments_round_trip_case_two)
  ]
witnessesFor _ = []
...
runQuickCheck "PathSegmentsRoundTrip" =
  qcDrive (QC.forAll GQ.gen_path_segments_round_trip
                     (qcProp P.property_path_segments_round_trip))
...
runHedgehog "PathSegmentsRoundTrip" =
  hhDrive GH.gen_path_segments_round_trip P.property_path_segments_round_trip
...
runFalsify "PathSegmentsRoundTrip" =
  fsDrive GF.gen_path_segments_round_trip P.property_path_segments_round_trip
...
runSmallCheck "PathSegmentsRoundTrip" =
  scDrive GS.series_path_segments_round_trip P.property_path_segments_round_trip
